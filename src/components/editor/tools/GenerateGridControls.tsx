...
const GenerateGridControls: React.FC = () => {
  ...
  return (
    <div className='rounded-md border border-gray-700 p-2'>
      <button
        type='button'
        className='flex w-full cursor-pointer select-none items-center gap-2 text-left text-sm text-gray-300'
        onClick={() => setOpen((s) => !s)}
        aria-expanded={open}
        title='Show or hide generate grid options'
      >
        <span className='flex items-center gap-2'>Generate Grid</span>
        ...
        <>
          <div className='flex gap-2 pt-2'>
            ...
            <input
              ...
              className='w-12 rounded bg-gray-800 px-2 py-1 text-white'
